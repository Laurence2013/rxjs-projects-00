/*
	...
	desc-08: Part 3, using combineAll
	goal:
	line-code-added:
*/

const { fromEvent, of, combineLatest, interval } = require('rxjs');
const { mergeAll, map, filter, combineAll, concatAll } = require('rxjs/operators');
...
const market00$ = source00$.pipe(
	concatAll(marketSentiment$, economicIndicators$)
);

market00$.subscribe(analysis => {
